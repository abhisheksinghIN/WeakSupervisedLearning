...
#from models.transunet import CBAM_UNet
...
def main():
    ...
    # general
    parser.add_argument('--experiment_name', type=str, default="experiment_CBAM_sensitivity-0.1",
    ...
    parser.add_argument('--val_freq', type=int, default=5080,
                        help='validation will be run every val_freq \
                        batches/optimization steps during training')
    parser.add_argument('--save_freq', type=int, default=5080,
                        help='training state will be saved every save_freq \
                        batches/optimization steps during training')
    parser.add_argument('--log_freq', type=int, default=5080,
    ...
    parser.add_argument('--use_s2mr', action='store_true', default=True,
                        help='use sentinel-2 medium-resolution (20 m) bands')
    parser.add_argument('--use_s2lr', action='store_true', default=True,
    ...
    parser.add_argument('--lr', type=float, default=0.1, #default = 0.01
    ...
    # network
#    parser.add_argument('--model', type=str, choices=['deeplab', 'unet', 'UNet_Attention'],
#                        default='UNet_Attention',
#                        help="network architecture (default: deeplab)")
    parser.add_argument('--model', type=str, choices=['deeplab', 'unet', 'UNet_Attention', 'CBAM_UNet', 'SegFormer'],
                        default='CBAM_UNet',
                        help="network architecture (default: deeplab)")
    # deeplab-specific
    ...
    # data
    parser.add_argument('--data_dir_train', type=str, default="/workspace/sen12ms/data",
    ...
    parser.add_argument('--dataset_val', type=str, default='sen12ms_holdout',
                        ...
                        help='dataset to use for validation (default: \
                             sen12ms_holdout)')
#    parser.add_argument('--dataset_val', type=str, default='dfc2020_val',
#                        choices=['sen12ms_holdout', 'dfc2020_val',
#                                 'dfc2020_test'],
#                        help='dataset to use for validation (default: \
#                             sen12ms_holdout)')
    parser.add_argument('--data_dir_val', type=str, default="/workspace/sen12ms",
                        help='path to validation dataset')
    parser.add_argument('--log_dir', type=str, default='/workspace/sen12ms/dfc/code/12_08_2024logs/sensitivity-ablation-CBAM/',
    ...
    if args.dataset_val == "sen12ms_holdout":
        ...
        val_set = DFC2020(args.data_dir_val,
                          ...
                          use_s2lr=args.use_s2lr,
                          use_s1=args.use_s1)
    n_classes_val = val_set.n_classes
    print(n_classes_val)
    n_inputs_val = val_set.n_inputs
    print(n_inputs_val)
...
###############################################################
        ...
        model = CBAM_UNet(n_channels=n_inputs, n_classes=n_classes)
